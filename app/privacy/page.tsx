...
export const metadata: Metadata = {
  ...
  description:
    "Learn how CanYouRunAI.com protects your privacy and handles system information during compatibility checks.",
  openGraph: {
    title: "Privacy Policy | CanYouRunAI.com",
    description:
      "Our commitment to protecting your privacy while checking AI compatibility",
  },
};
      ...
      <Card className="max-w-4xl mx-auto p-8 prose prose-sm md:prose-base lg:prose-lg dark:prose-invert prose-headings:font-bold prose-a:text-primary">
        ...
        <ul>
          ...
          <li>
            ...
            <i>control</i> means ownership of 50% or more of the shares, equity
            interest or other securities entitled to vote for election of
            directors or other managing authority.
          </li>
          <li>
            <strong>Company</strong> (referred to as either{" "}
            <i>the Company, We, Us or Our</i> in this Agreement) refers to Can
            You Run AI.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to Can You Run AI, accessible from
            www.canyourunai.com
          </li>
        </ul>
        ...
        <p>
          ...
          <i>Last updated</i> date at the top of this Privacy Policy.
        </p>
