  ...
  return (
    <div className="min-h-screen py-16 px-6">
      <Card className="max-w-4xl mx-auto p-8 prose prose-sm md:prose-base lg:prose-lg dark:prose-invert prose-headings:font-bold prose-a:text-primary">
        ...
        <p>
          CanYouRunAI.com is a free tool that helps you determine if your computer has the necessary hardware 
          requirements to run Large Language Models (LLMs) locally. We analyze your system specifications and 
          compare them against the requirements of various AI models.
        </p>

        <h3>How does the system check work?</h3>
        <p>
          When you click &quot;Can You Run This AI?&quot;, our tool downloads a small executable that scans your system 
        ...
        <p>
          This information is then compared against the requirements of your selected AI model to determine compatibility.
        </p>
        ...
        <p>
          We offer compatibility checking for popular LLMs including:
        </p>
        <ul>
        ...
        <p>
          Hardware requirements vary significantly between models. As a general guide:
        </p>
        <ul>
        ...
        <p>
          Our Advanced Analysis feature allows you to check any model from Hugging Face against your system 
          specifications. It provides detailed information about:
        </p>
        <ul>
        ...
        <p>
          Quantization is a technique that reduces the precision of the model&apos;s weights to decrease memory 
          usage and improve inference speed, often with minimal impact on performance. Our advanced analysis 
          shows various quantization options (4-bit, 8-bit, etc.) and their memory requirements.
        </p>
        ...
        <p>
          Yes. We only collect system specifications necessary for the analysis. This information is not 
          stored permanently and is only used to provide you with accurate compatibility results. You can 
        ...
        <ul>
          <li>Ensure your antivirus isn&apos;t blocking the system check executable</li>
        ...
        <p>
          Our system requirements are based on real-world testing and manufacturer recommendations. However, 
          actual performance may vary based on factors like:
        </p>
        <ul>
