      ...
      <Card className="max-w-4xl mx-auto p-8 prose prose-sm md:prose-base lg:prose-lg dark:prose-invert prose-headings:font-bold prose-a:text-primary">
        ...
        <ul>
          ...
          <li>
            ...
            &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Can You Run AI.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean
            these Terms and Conditions that form the entire agreement between You
            and the Company regarding the use of the Service.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Can You Run AI, accessible from{" "}
            <a href="https://www.canyourunai.com" rel="external nofollow noopener" target="_blank">
              www.canyourunai.com
            </a></p>
          </li>
          <li>
        ...
        <p>
          ...
          the amount actually paid by You through the Service or 100 USD if You
