...
export const metadata: Metadata = {
  ...
  description:
    "Terms and conditions for using CanYouRunAI.com system compatibility checker for AI models.",
  openGraph: {
    title: "Terms and Conditions | CanYouRunAI.com",
    description: "Terms of service for using our AI compatibility checker",
  },
};
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Can You Run AI.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              <a
                href="https://www.canyourunai.com"
