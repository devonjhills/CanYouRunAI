      ...
      <section className="space-y-6 max-w-7xl mx-auto">
        ...
        <div className="text-center space-y-4 p-6 bg-muted/30 rounded-xl shadow-sm">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            For advanced users: Check memory requirements and performance estimates for specific Hugging Face models.
          </p>
        </div>
          ...
          <CardContent className="space-y-8 p-6">
            ...
            <div className="rounded-xl overflow-hidden shadow-sm">
              <div className="bg-primary/20 p-4 border-b">
                <label className="text-lg font-semibold">Hugging Face Model ID</label>
              </div>
              <div className="p-4 bg-background">
            ...
            {analysis && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {Object.entries(analysis.quantizationResults).map(([level, result]) => (
                    <Card
                      key={level}
                      className={cn(
                    ...
                    >
                      <div className={cn(
                        "p-4 border-b",
                        result.runType === "Won't run" ? "bg-destructive/20" : "bg-success/20"
                      )}>
                          ...
                          <Tooltip>
                            <TooltipTrigger className="flex items-center gap-1.5 group">
                              <h3
                                className={cn(
                                  ...
                                  result.runType === "Won't run" && "text-destructive"
                                )}
                              >
                                {level}
                              </h3>
                            ...
                            <TooltipContent>
                              <p className="max-w-xs">
                                Quantization level:{" "}
                                {QUANTIZATION_BPWS[level as keyof typeof QUANTIZATION_BPWS]} bits per weight.
                                Lower values use less memory but may reduce model quality.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </div>
                      ...
                      <div className="p-4 bg-background space-y-3 text-sm">
                        <div className="flex justify-between">
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>Indicates whether the model can run on your system and how</p>
                            </TooltipContent>
                          </Tooltip>
                          <span className={cn(result.runType === "Won't run" && "text-destructive")}>
                            {result.runType}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          ...
                          <span>{result.memoryRequired?.toFixed(1) ?? "N/A"} GB</span>
                        </div>
                        {result.tokensPerSecond != null && (
                          <div className="flex justify-between">
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Estimated text generation speed in tokens per second</p>
                              </TooltipContent>
                            </Tooltip>
                            <span>{formatTokensPerSecond(result.tokensPerSecond)}</span>
                          </div>
                        )}
                        {result.maxContext != null && (
                          <div className="flex justify-between">
                            ...
                            <span>{result.maxContext.toLocaleString()} tokens</span>
                          </div>
                        )}
                      </div>
                    </Card>
            ...
            {error && (
              <div className="rounded-xl overflow-hidden shadow-sm">
                <div className="bg-destructive/20 p-4">
                  <p className="font-medium text-destructive">Error analyzing model:</p>
                  ...
                  <Card className="shadow-sm">
                    ...
                    <div className="p-4 bg-background space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-mono text-sm">{analysis.systemSpecs.totalRam} GB</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 min-w-[6rem]">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-mono text-sm">{analysis.systemSpecs.vramPerGpu} GB</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 min-w-[6rem]">
                        ...
                        <span className="font-mono text-sm">{analysis.systemSpecs.numGpus}</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 min-w-[6rem]">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>Graphics memory transfer speed in GB/s</p>
                            </TooltipContent>
                          </Tooltip>
                        </div>
                        <span className="font-mono text-sm">{analysis.systemSpecs.gpuBandwidth} GB/s</span>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card className="shadow-sm">
                    ...
                    <div className="p-4 bg-background space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span>{analysis.modelConfig?.architecture ?? "N/A"}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span>{analysis.modelConfig?.parameterSize ?? "N/A"}</span>
                      </div>
                    </div>
                  </Card>
                )}
