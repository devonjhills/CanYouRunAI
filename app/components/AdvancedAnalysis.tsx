            ...
            <div className="space-y-12">
                  ...
                  <div className="p-4 bg-background">
                    ...
                    >
                      <div className="text-sm text-muted-foreground">
                        {(() => {
                          const cleanDescription = cleanModelDescription(analysis.modelSummary.description);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {Object.entries(analysis.quantizationResults).map(
                  ([level, result], index) => (
                    <Card key={level} className="overflow-hidden border-2 border-foreground neo-brutalist-shadow">
                      <div className={cn(
                        ...
                        <h3 className="text-lg font-semibold">{level} Quantization</h3>
                      </div>
