  ...
  return (
    <TooltipProvider>
      <section className="space-y-4 max-w-7xl mx-auto">
        <div className="text-center space-y-4 p-6 bg-muted/30 rounded-xl border-2 border-foreground">
        ...
        <Card className="neo-brutalist-box border-2 border-foreground">
                  ...
                  {Object.entries(analysis.quantizationResults).map(
                    ([level, result]) => (
                      <Card
                        key={level}
                        className={cn(
                          "overflow-hidden border-2 border-foreground neo-brutalist-shadow transition-all hover:shadow-lg",
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 min-w-32">
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>
                                Graphics memory transfer speed in gigabytes per
                                second
                              </p>
                            </TooltipContent>
                          </Tooltip>
